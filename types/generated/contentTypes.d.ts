...
export interface ApiBeautifulGardenSectionBeautifulGardenSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'beautiful_garden_sections';
  info: {
    displayName: 'BeautifulGardenSection';
    pluralName: 'beautiful-garden-sections';
    singularName: 'beautiful-garden-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    CardService: Schema.Attribute.Component<'card-service.card-service', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::beautiful-garden-section.beautiful-garden-section'
    > &
      Schema.Attribute.Private;
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    formFields: Schema.Attribute.Component<'contact-page.formfield', true>;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    newsletter_heading: Schema.Attribute.Text;
...
export interface ApiGalleryItemGalleryItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    frame: Schema.Attribute.Enumeration<
      ['classic,', 'modern,', 'artistic,', 'minimal,', 'vintage']
    > &
      Schema.Attribute.Required &
...
export interface ApiHeroSlideHeroSlide extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ctaPath: Schema.Attribute.String;
    description: Schema.Attribute.String;
...
export interface ApiProjectCategoryProjectCategory
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Projects: Schema.Attribute.Component<'project-category.projects', true>;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::beautiful-garden-section.beautiful-garden-section': ApiBeautifulGardenSectionBeautifulGardenSection;
